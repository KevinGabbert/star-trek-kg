...
namespace UnitTests.ShipTests.MapTests
{
    ...
    public class MapTests: TestClass_Base
    {
        ...
        public void Remove()
        {
            ...
            var hostileShip = new Ship(FactionName.Klingon, "this is the ship", sector, this.Game.Map, _setup.Game);
        ...
        public void Remove2()
        {
            ...
            var hostileShip = new Ship(FactionName.Klingon, "this is the ship", ship, this.Game.Map, _setup.Game);
        ...
        public void Remove3()
        {
            ...
            //add a ship
            var hostileShip = new Ship(FactionName.Klingon, "ship1", new Sector(new LocationDef(new Coordinate(0, 0), new Coordinate(2, 7))), this.Game.Map, _setup.Game);
            var hostileShip2 = new Ship(FactionName.Klingon, "ship2", new Sector(new LocationDef(new Coordinate(0, 0), new Coordinate(2, 2))), this.Game.Map, _setup.Game);

...
namespace UnitTests.ShipTests.ShipObjectTests
{
    ...
    public class Test_ShipObject
    {
        ...
        public void Basic_Instantiation()
        {
            ...
            var shipToTest = new Ship(FactionName.Klingon, "TestShip", _mockSector.Object, _mockMap.Object, _mockGame.Object);
        ...
        public void Test_AbsorbHit_NoDamage()
        {
            ...
            var attacker = new Ship(FactionName.Klingon, "The attacking Ship", _mockSector.Object, _mockMap.Object, _mockGame.Object);

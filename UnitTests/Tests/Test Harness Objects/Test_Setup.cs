...
namespace UnitTests.ShipTests
{
    public class Test_Setup: IConfig
    {
        ...
        public void SetupMapWith2Hostiles()
        {
            ...
            //add a ship
            var hostileShip = new Ship(FactionName.Klingon, "ship1", new Sector(new LocationDef(new Coordinate(0, 0), new Coordinate(2, 7))), this.TestMap, this.TestMap.Game);
            var hostileShip2 = new Ship(FactionName.Klingon, "ship2", new Sector(new LocationDef(new Coordinate(0, 0), new Coordinate(2, 5))), this.TestMap, this.TestMap.Game);
